...
.field private f:Landroid/support/v7/widget/cq;

.field private g:Landroid/support/v7/widget/cq;
...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/aj;I)Landroid/support/v7/widget/cq;
    .locals 3
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/cq;->d:Z

    .line 152
    iput-object v1, v0, Landroid/support/v7/widget/cq;->a:Landroid/content/res/ColorStateList;
...
.method a()V
    ...
    .prologue
    .line 130
    iget-object v0, p0, Landroid/support/v7/widget/ba;->d:Landroid/support/v7/widget/cq;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ba;->e:Landroid/support/v7/widget/cq;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ba;->f:Landroid/support/v7/widget/cq;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ba;->g:Landroid/support/v7/widget/cq;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ba;->d:Landroid/support/v7/widget/cq;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/ba;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/cq;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ba;->e:Landroid/support/v7/widget/cq;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ba;->f:Landroid/support/v7/widget/cq;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ba;->g:Landroid/support/v7/widget/cq;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/ba;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/cq;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/cq;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/aj;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/cq;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v4, v0, v6}, Landroid/support/v7/widget/ba;->a(Landroid/content/Context;Landroid/support/v7/widget/aj;I)Landroid/support/v7/widget/cq;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/ba;->d:Landroid/support/v7/widget/cq;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/ba;->e:Landroid/support/v7/widget/cq;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/ba;->f:Landroid/support/v7/widget/cq;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ba;->g:Landroid/support/v7/widget/cq;
...
.method a(Z)V
    ...
    invoke-direct {v0, v2}, Landroid/support/v7/b/a;-><init>(Landroid/content/Context;)V

...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    .prologue
    .line 1945
    iput-object p1, p0, Landroid/support/v7/widget/cw;->c:Landroid/support/v7/widget/Toolbar;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/ct;)V
    .locals 0

    .prologue
    .line 1945
    invoke-direct {p0, p1}, Landroid/support/v7/widget/cw;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/g;)V
    ...
    .prologue
    .line 1952
    iget-object v0, p0, Landroid/support/v7/widget/cw;->a:Landroid/support/v7/view/menu/g;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/cw;->b:Landroid/support/v7/view/menu/j;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/cw;->b:Landroid/support/v7/view/menu/j;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/g;->d(Landroid/support/v7/view/menu/j;)Z

    .line 1955
    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/cw;->a:Landroid/support/v7/view/menu/g;
...
.method public a(Landroid/support/v7/view/menu/g;Landroid/support/v7/view/menu/j;)Z
    ...
    .line 2007
    iget-object v0, p0, Landroid/support/v7/widget/cw;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/cw;->c:Landroid/support/v7/widget/Toolbar;
    ...
    .line 2012
    iput-object p2, p0, Landroid/support/v7/widget/cw;->b:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/Toolbar;->d()Landroid/support/v7/widget/cx;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/cw;->c:Landroid/support/v7/widget/Toolbar;
...
.method public b(Z)V
    ...
    .line 1969
    iget-object v1, p0, Landroid/support/v7/widget/cw;->a:Landroid/support/v7/view/menu/g;
    ...
    .line 1972
    iget-object v3, p0, Landroid/support/v7/widget/cw;->a:Landroid/support/v7/view/menu/g;
    ...
    .line 1973
    iget-object v4, p0, Landroid/support/v7/widget/cw;->b:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/cw;->b(Landroid/support/v7/view/menu/g;Landroid/support/v7/view/menu/j;)Z
...
.method public b(Landroid/support/v7/view/menu/g;Landroid/support/v7/view/menu/j;)Z
    ...
    .line 2045
    iput-object v2, p0, Landroid/support/v7/widget/cw;->b:Landroid/support/v7/view/menu/j;

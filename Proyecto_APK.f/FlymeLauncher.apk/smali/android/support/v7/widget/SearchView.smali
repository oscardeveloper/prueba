...
# static fields
.field static final a:Landroid/support/v7/widget/cf;
...
.field private q:Landroid/support/v7/widget/ch;

.field private r:Landroid/support/v7/widget/cg;

.field private s:Landroid/view/View$OnFocusChangeListener;

.field private t:Landroid/support/v7/widget/ci;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/cf;
...
.method private l()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/cl;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    :cond_2
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cl;->a(I)V
...
.method private m()V
    ...
    .line 1158
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/ch;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/ch;->a(Ljava/lang/String;)Z
...
.method private o()V
    ...
    .line 1178
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/cg;
...
.method private q()V
    ...
    .prologue
    .line 1662
    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/cf;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cf;->a(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cf;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1320
    :cond_0
    check-cast p1, Landroid/support/v7/widget/cj;

    .line 1321
    invoke-virtual {p1}, Landroid/support/v7/widget/cj;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1322
    iget-boolean v0, p1, Landroid/support/v7/widget/cj;->a:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Landroid/support/v7/widget/cj;-><init>(Landroid/os/Parcelable;)V
    ...
    iput-boolean v0, v1, Landroid/support/v7/widget/cj;->a:Z
...
.method public setOnCloseListener(Landroid/support/v7/widget/cg;)V
    .locals 0

    .prologue
    .line 534
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/cg;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/ch;)V
    .locals 0

    .prologue
    .line 525
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/ch;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/ci;)V
    .locals 0

    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/ci;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v0, v0, Landroid/support/v7/widget/cl;

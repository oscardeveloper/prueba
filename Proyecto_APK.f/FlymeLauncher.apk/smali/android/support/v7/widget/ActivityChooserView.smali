...
.field private k:Landroid/support/v7/widget/bj;
...
.method private a(I)V
    ...
    .line 366
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/bj;
    ...
    .line 374
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/bj;->f(I)V

    .line 375
    invoke-virtual {v3}, Landroid/support/v7/widget/bj;->c()V
    ...
    .line 379
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/bj;->m()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/bj;
    .locals 2

    .prologue
    .line 503
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/bj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/bj;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bj;->a(Landroid/widget/ListAdapter;)V

    .line 506
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/bj;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/bj;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bj;->a(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bj;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bj;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

...
.field private w:Landroid/support/v4/widget/ap;

.field private x:Landroid/support/v4/view/dq;

.field private final y:Landroid/support/v4/view/ee;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/ee;
...
.method static synthetic a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/view/dq;)Landroid/support/v4/view/dq;
    .locals 0

    .prologue
    .line 50
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/view/dq;
...
.method private a(Landroid/content/Context;)V
    ...
    .line 150
    invoke-static {p1}, Landroid/support/v4/widget/ap;->a(Landroid/content/Context;)Landroid/support/v4/widget/ap;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/ap;
...
.method private a(FF)Z
    ...
    .line 599
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/ap;
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/support/v4/widget/ap;->a(IIIIIIII)V
...
.method static synthetic b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/view/ee;
    .locals 1

    .prologue
    .line 50
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/ee;
...
.method private c()V
    ...
    .line 573
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/view/dq;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/view/ViewCompat;->g(Landroid/view/View;)F
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/ViewCompat;->g(Landroid/view/View;)F
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 219
    invoke-static {p0}, Landroid/support/v4/view/ViewCompat;->k(Landroid/view/View;)V

...
.method public a(Landroid/app/Activity;)V
    ...
    .prologue
    .line 266
    invoke-super {p0, p1}, Landroid/support/v4/app/l;->a(Landroid/app/Activity;)V
...
.method a(Z)V
    ...
    .line 192
    invoke-virtual {p0}, Landroid/support/v4/app/DialogFragment;->i()Landroid/support/v4/app/r;

    move-result-object v0

    iget v1, p0, Landroid/support/v4/app/DialogFragment;->e:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v4/app/r;->a(II)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/r;->a()Landroid/support/v4/app/FragmentTransaction;

    move-result-object v0

    .line 197
    invoke-virtual {v0, p0}, Landroid/support/v4/app/FragmentTransaction;->a(Landroid/support/v4/app/l;)Landroid/support/v4/app/FragmentTransaction;
...
.method public b(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
    ...
    .line 305
    invoke-super {p0, p1}, Landroid/support/v4/app/l;->b(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
    ...
    .line 323
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/DialogFragment;->D:Landroid/support/v4/app/o;

    const-string v1, "layout_inflater"

    invoke-virtual {v0, v1}, Landroid/support/v4/app/o;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public b()V
    ...
    .prologue
    .line 276
    invoke-super {p0}, Landroid/support/v4/app/l;->b()V
...
.method public c(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/DialogFragment;->g()Landroid/support/v4/app/o;
...
.method public d(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 369
    invoke-super {p0, p1}, Landroid/support/v4/app/l;->d(Landroid/os/Bundle;)V
    ...
    .line 375
    :cond_1
    invoke-virtual {p0}, Landroid/support/v4/app/DialogFragment;->m()Landroid/view/View;
...
.method public e()V
    ...
    .prologue
    .line 442
    invoke-super {p0}, Landroid/support/v4/app/l;->e()V

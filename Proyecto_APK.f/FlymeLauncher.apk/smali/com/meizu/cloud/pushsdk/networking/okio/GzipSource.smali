...
.method public constructor <init>(Lcom/meizu/cloud/pushsdk/networking/okio/Source;)V
    ...
    iput-object v0, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->source:Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;

    .line 64
    new-instance v0, Lcom/meizu/cloud/pushsdk/networking/okio/InflaterSource;

    iget-object v1, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->source:Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;

    iget-object v2, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->inflater:Ljava/util/zip/Inflater;

    invoke-direct {v0, v1, v2}, Lcom/meizu/cloud/pushsdk/networking/okio/InflaterSource;-><init>(Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;Ljava/util/zip/Inflater;)V

    iput-object v0, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->inflaterSource:Lcom/meizu/cloud/pushsdk/networking/okio/InflaterSource;
...
.method private consumeHeader()V
    ...
    invoke-interface {v0, v2, v3}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->require(J)V
    ...
    invoke-direct {p0, v1, v2, v0}, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->checkEqual(Ljava/lang/String;II)V
    ...
    invoke-interface {v0, v2, v3}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->skip(J)V
    ...
    invoke-interface {v0, v1}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->indexOf(B)J
    ...
    invoke-interface {v1}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->readShortLe()S
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->checkEqual(Ljava/lang/String;II)V

    .line 164
    iget-object v0, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->crc:Ljava/util/zip/CRC32;
...
.method private consumeTrailer()V
    ...
    invoke-interface {v1}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->readIntLe()I
...
.method private updateCrc(Lcom/meizu/cloud/pushsdk/networking/okio/Buffer;JJ)V
    ...
    .line 197
    iget-object v5, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->crc:Ljava/util/zip/CRC32;

    iget-object v6, v0, Lcom/meizu/cloud/pushsdk/networking/okio/Segment;->data:[B
...
.method public read(Lcom/meizu/cloud/pushsdk/networking/okio/Buffer;J)J
    ...
    .line 72
    :cond_1
    iget v2, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->section:I
    ...
    .line 74
    iput v3, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->section:I
    ...
    .line 80
    iget-object v4, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->inflaterSource:Lcom/meizu/cloud/pushsdk/networking/okio/InflaterSource;

    invoke-virtual {v4, p1, p2, p3}, Lcom/meizu/cloud/pushsdk/networking/okio/InflaterSource;->read(Lcom/meizu/cloud/pushsdk/networking/okio/Buffer;J)J
    ...
    .line 85
    :cond_3
    iput v7, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->section:I
    ...
    iput v2, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->section:I

    .line 99
    iget-object v2, p0, Lcom/meizu/cloud/pushsdk/networking/okio/GzipSource;->source:Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;

    invoke-interface {v2}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->exhausted()Z

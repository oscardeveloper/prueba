...
.method public constructor <init>(Lcom/meizu/cloud/pushsdk/networking/okio/Source;Ljava/util/zip/Inflater;)V
    ...
    invoke-direct {p0, v0, p2}, Lcom/meizu/cloud/pushsdk/networking/okio/InflaterSource;-><init>(Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;Ljava/util/zip/Inflater;)V
...
.method public read(Lcom/meizu/cloud/pushsdk/networking/okio/Buffer;J)J
    ...
    .line 58
    :cond_0
    iget-boolean v2, p0, Lcom/meizu/cloud/pushsdk/networking/okio/InflaterSource;->closed:Z
    ...
    :try_start_0
    invoke-virtual {p1, v1}, Lcom/meizu/cloud/pushsdk/networking/okio/Buffer;->writableSegment(I)Lcom/meizu/cloud/pushsdk/networking/okio/Segment;
...
.method public refill()Z
    ...
    invoke-interface {v1}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->exhausted()Z
    ...
    invoke-interface {v1}, Lcom/meizu/cloud/pushsdk/networking/okio/BufferedSource;->buffer()Lcom/meizu/cloud/pushsdk/networking/okio/Buffer;

    move-result-object v1

    iget-object v1, v1, Lcom/meizu/cloud/pushsdk/networking/okio/Buffer;->head:Lcom/meizu/cloud/pushsdk/networking/okio/Segment;
